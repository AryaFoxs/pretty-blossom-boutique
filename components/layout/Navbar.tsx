  ...
  return (
    <header
      className={cn(
        ...
        isScrolled
          ? "bg-white/95 backdrop-blur-lg shadow-lg shadow-gold-100/20"
          : "bg-transparent"
      )}
    >
      <nav className="container">
        <div className="flex h-20 items-center justify-between">
              ...
              <Link
                ...
                className={cn(
                  ...
                  pathname === item.href
                    ...
                    : "text-warm-600 hover:text-gold-600 hover:bg-gold-50/50"
                )}
              >
                {item.name}
              </Link>
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-lg text-warm-600 hover:bg-gold-50 transition-colors"
        ...
        >
          <div className="flex flex-col gap-1 pt-4 border-t border-cream-200">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
